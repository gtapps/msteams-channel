...
| Clicking Accept on a file offer does nothing | The upload is performed by the running channel server, so it has to be up when the recipient clicks. Offers also expire after an hour; ask Claude to send the file again. |
