...
| A file offered in a DM shows a card with no Accept button | The uploaded Teams app manifest is missing `supportsFiles: true`. Add it and re-upload the app package; see [SETUP.md](SETUP.md#file-sending-to-channels-and-group-chats). |
